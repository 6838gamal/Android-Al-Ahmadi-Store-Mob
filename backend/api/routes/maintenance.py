...
MAINT_STATUS_NOTIFICATIONS = {
    ...
    "unrepairable_visit":  ("جهازك يحتاج زيارة المحل 🔴", "جهازك غير قابل للإصلاح الآن ويحتاج إلى تفتيش في المحل. يرجى التواصل مع فريقنا"),
    "unrepairable_other":  ("جهازك غير قابل للإصلاح 🔴", "للأسف، جهازك غير قابل للإصلاح حالياً. يرجى التواصل مع فريقنا لمزيد من التفاصيل"),
}
