...
- [Flutter image URL fix](image-url-fix.md) — Use ApiClient.img(path) for ALL image URLs; static method resolves runtime origin (Replit proxy vs Render.com); admin panel templates use |bu Jinja2 filter
